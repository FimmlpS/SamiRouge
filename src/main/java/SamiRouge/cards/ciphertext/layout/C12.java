...
public class C12 extends AbstractCipherTextCard {
    public static final String ID = "samirg:C12";
    ...
    public C12() {
        ...
        this.cipherText = new CipherText(cardStrings.NAME,cardStrings.EXTENDED_DESCRIPTION[0],"").setData(this, CipherText.CipherType.Layout, CipherText.CipherColor.Soul).setTheX(3);
    }
}
