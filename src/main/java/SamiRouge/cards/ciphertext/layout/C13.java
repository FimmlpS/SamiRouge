...
public class C13 extends AbstractCipherTextCard {
    public static final String ID = "samirg:C13";
    ...
    public C13() {
        ...
        this.cipherText = new CipherText(cardStrings.NAME,cardStrings.EXTENDED_DESCRIPTION[0],"").setData(this, CipherText.CipherType.Layout, CipherText.CipherColor.Nature).setTheX(1);
    }
}
