...
public class C06 extends AbstractCipherTextCard {
    public static final String ID = "samirg:C06";
    ...
    public C06() {
        ...
        this.cipherText = new CipherText(cardStrings.NAME,cardStrings.EXTENDED_DESCRIPTION[0],"").setData(this, CipherText.CipherType.Layout, CipherText.CipherColor.Group).setTheX(3);
    }
}
