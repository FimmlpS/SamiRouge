...
public class C18 extends AbstractCipherTextCard {
    public static final String ID = "samirg:C18";
    ...
    public C18() {
        ...
        this.cipherText = new CipherText(cardStrings.NAME,cardStrings.EXTENDED_DESCRIPTION[0],"").setData(this, CipherText.CipherType.Layout, CipherText.CipherColor.Nature).setTheX(3);
    }
}
