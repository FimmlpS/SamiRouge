...
public class Freeze_SamiRouge extends AbstractSamiRougeCard {

    public static final String ID = "Freeze_SamiRouge";
    private static final CardStrings cardStrings;

    public Freeze_SamiRouge(){
