...
public class BlightAboveCreatureEffect extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.blight.outlineImg, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F, this.scale * (2.5F - this.duration), this.scale * (2.5F - this.duration), this.rotation, 0, 0, 128, 128, false, false);
        sb.setColor(this.color);
        sb.draw(this.blight.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F, this.scale * (2.5F - this.duration), this.scale * (2.5F - this.duration), this.rotation, 0, 0, 128, 128, false, false);
        sb.setBlendFunction(770, 1);
        this.shineColor.a = this.color.a / 4.0F;
        sb.setColor(this.shineColor);
        sb.draw(this.blight.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F, this.scale * (2.7F - this.duration), this.scale * (2.7F - this.duration), this.rotation, 0, 0, 128, 128, false, false);
        sb.draw(this.blight.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F, this.scale * (3.0F - this.duration), this.scale * (3.0F - this.duration), this.rotation, 0, 0, 128, 128, false, false);
