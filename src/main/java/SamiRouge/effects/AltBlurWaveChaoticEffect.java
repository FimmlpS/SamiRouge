...
public class AltBlurWaveChaoticEffect extends AbstractGameEffect {
    ...
    public AltBlurWaveChaoticEffect(float x, float y, Color color, float chosenSpeed) {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, (float)this.img.packedWidth / 2.0F, (float)this.img.packedHeight / 2.0F, (float)this.img.packedWidth, (float)this.img.packedHeight, this.scale + MathUtils.random(-0.1F, 0.1F), this.scale + MathUtils.random(-0.1F, 0.1F), this.rotation + this.flipper + MathUtils.random(-30.0F, 30.0F));
