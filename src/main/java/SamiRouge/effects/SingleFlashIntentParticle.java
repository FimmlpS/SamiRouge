...
public class SingleFlashIntentParticle extends AbstractGameEffect {
    ...
    public SingleFlashIntentParticle(AbstractSamiMonster.ExtraIntent extraIntent) {
        this.duration = 1.0F;
        this.img = extraIntent.intentImg;
        W = img.getWidth();
        this.x = extraIntent.intentHb.cX - (float)W / 2.0F;
        this.y = extraIntent.intentHb.cY - (float)W / 2.0F;
