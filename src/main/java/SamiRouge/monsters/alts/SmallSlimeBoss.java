...
public class SmallSlimeBoss extends AbstractMonster {
    private static final Logger logger = LogManager.getLogger(SlimeBoss.class.getName());
    public static final String ID = "samirg:SmallSlimeBoss";
    ...
    public SmallSlimeBoss(float x, float y, int newHealth) {
        super(NAME, ID, newHealth, 0.0F, -30.0F, 150.0F, 130.0F, (String)null, x, y);
...
//        }
        ...
        this.loadAnimation("images/monsters/theBottom/boss/slime/skeleton.atlas", "images/monsters/theBottom/boss/slime/skeleton.json", 2.5F);
