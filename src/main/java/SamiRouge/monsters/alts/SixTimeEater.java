...
import SamiRouge.powers.TimeWrapAltPower;
...
public class SixTimeEater extends AbstractMonster {
    public static final String ID = "samirg:SixTimeEater";
    ...
    public SixTimeEater(int clockAmount) {
        super(NAME, ID, 456, -10.0F, -30.0F, 476.0F, 410.0F, (String)null, -50.0F, 30.0F);
    ...
    public void usePreBattleAction() {
        ...
        TimeWrapAltPower time = new TimeWrapAltPower(this);
        time.amount = clockAmount;
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, time));
    }
    ...
    public void takeTurn() {
        if (this.firstTurn) {
            if (AbstractDungeon.player.chosenClass == AbstractPlayer.PlayerClass.WATCHER) {
                ...
                AbstractDungeon.actionManager.addToBottom(new TalkAction(this, DIALOG[clockAmount==0?0:3], 0.5F, 2.0F));
            }
        ...
        switch(this.nextMove) {
            ...
            case 4:
                ...
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, (DamageInfo)this.damage.get(1), AbstractGameAction.AttackEffect.POISON));
