...
public class AltAcidSlime extends AbstractMonster {
    public static final String ID = "samirg:AltAcidSlime";
    ...
    public AltAcidSlime(float x, float y) {
        this(x, y, 0, 69);
    ...
    public AltAcidSlime(float x, float y, int poisonAmount, int newHealth) {
        super(NAME, ID, newHealth, 0.0F, 0.0F, 300.0F, 180.0F, (String)null, x, y, true);
        this.saveX = x;
        this.saveY = y;
    ...
    public void takeTurn() {
        switch(this.nextMove) {
            ...
            case 3:
                ...
                AbstractDungeon.actionManager.addToBottom(new SpawnMonsterAction(new SmallSlimeBoss(this.saveX - 134.0F, this.saveY + MathUtils.random(-4.0F, 4.0F), this.currentHealth), false));
                AbstractDungeon.actionManager.addToBottom(new SpawnMonsterAction(new SmallSlimeBoss(this.saveX + 134.0F, this.saveY + MathUtils.random(-4.0F, 4.0F), this.currentHealth), false));
