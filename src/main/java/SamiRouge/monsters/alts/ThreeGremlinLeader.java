...
import SamiRouge.actions.SpecialSummonGremlinAction;
...
public class ThreeGremlinLeader extends AbstractMonster {
    public static final String ID = "samirg:ThreeGremlinLeader";
    ...
    public AbstractMonster[] gremlins = new AbstractMonster[4];
    ...
    public ThreeGremlinLeader() {
        super(NAME, ID, 172, 0.0F, -15.0F, 200.0F, 310.0F, (String)null, 125.0F, 0.0F);
    ...
    public void usePreBattleAction() {
        ...
        this.gremlins[2] = (AbstractMonster)AbstractDungeon.getMonsters().monsters.get(2);
        this.gremlins[3] = null;
    ...
    public void takeTurn() {
        ...
        switch(this.nextMove) {
            case 2:
                ...
                AbstractDungeon.actionManager.addToBottom(new SpecialSummonGremlinAction(this.gremlins));
                AbstractDungeon.actionManager.addToBottom(new SpecialSummonGremlinAction(this.gremlins));
                AbstractDungeon.actionManager.addToBottom(new SpecialSummonGremlinAction(this.gremlins));
                break;
            case 3:
    ...
    static {
        ...
        POSX = new float[]{-366.0F, -206.0F,-66F, -506.0F};
        POSY = new float[]{-4.0F, 6.0F,2.0F, 0.0F};
        RALLY_NAME = MOVES[0];
    }
}
