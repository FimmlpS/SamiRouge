...
public class AltSpikeSlime extends AbstractMonster {
    public static final String ID = "samirg:AltSpikeSlime";
    ...
    public AltSpikeSlime(float x, float y) {
        this(x, y, 0, 70);
    ...
    public AltSpikeSlime(float x, float y, int poisonAmount, int newHealth) {
