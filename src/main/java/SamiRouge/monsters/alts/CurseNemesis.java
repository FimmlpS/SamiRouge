...
public class CurseNemesis extends AbstractMonster {
    public static final String ID = "samirg:CurseNemesis";
    ...
    public CurseNemesis() {
        super(NAME, ID, 185, 5.0F, -10.0F, 350.0F, 440.0F, (String)null, 0.0F, 0.0F);
            ...
            case 4:
                ...
                if (AbstractDungeon.ascensionLevel >= 18) {
                    for(int i2 =0;i2<5;i2++){
                        addToBot(new MakeTempCardInDiscardAction(getRandomCurse(),1));
                    }
                } else {
